...
RESULTS_DIR = './results'        # Folder that contains subfolders 1..100, each with reason.txt
OUTPUT_FILE = './../reasoning.js'     # The JS file we will generate
...
def main():
    ...
    with open(OUTPUT_FILE, 'w', encoding='utf-8') as outfile:
        ...
        for idx in range(1, NUM_FILES + 1):
            reason_path = os.path.join(RESULTS_DIR, str(idx), "reason.txt")
